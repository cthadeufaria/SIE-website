	...
	?>
			...
			<form method = "POST" action = "actionUpdateFriend.php" enctype="multipart/form-data">
				...
				<table>
					...
					<tr>
						<td>Name:</td>
						<td><input type = "text" name = "friendName" value = "<?php echo $name; ?>" ></td>
					</tr>

					<tr>
						<td>Age:</td>
 						<td><input type = "text" name = "friendAge" value = "<?php echo $age; ?>" ></td>
					</tr>
					...
					<tr>
						<td></td>
						<td style="align:left"><input type = "submit" value = "Update friend"></td>
					</tr>
				</table>
